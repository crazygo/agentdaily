...
function generateContentHTML(items) {
  ...
  let html = `<aside class="lg:sticky lg:top-10">
    <div class="mb-4">
        <div class="text-xs uppercase tracking-wider text-[#6B6B6B] font-semibold">Mar 14 - Mar 20</div>
    </div>
    <nav class="flex flex-col">
        <div class="py-3 px-4 mb-2 border-l-3 border-black bg-[#F7F7F7] cursor-pointer transition-all text-sm font-semibold text-black">
            ...
            <div class="text-xs text-[#6B6B6B]">Mar 14 - Mar 20, 2026</div>
        </div>
    </nav>
</aside>
...
<main class="min-w-0">
    <div class="mb-12">
        ...
        <p class="text-xl text-[#292929] mb-4 font-normal">Mar 14, 2026 – Mar 20, 2026</p>
